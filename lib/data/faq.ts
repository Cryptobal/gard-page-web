...
const generalFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: `Puede solicitar una cotización completando el formulario en nuestra página web, llamando al ${companyStats.contactPhoneDisplay} o enviando un correo a comercial@gard.cl. Uno de nuestros asesores especializados se pondrá en contacto con usted en ${companyStats.commercialResponseSla}.`
  },
  {
