---
title: "Contrato de seguridad privada: cláusulas clave 2026"
date: "2026-08-03"
description: "Qué cláusulas debe exigir tu empresa en un contrato de servicio de seguridad privada en Chile: SLA, dotación, reemplazos, penalizaciones, seguros y registro."
author: "Gard Security"
keywords: ["contrato de seguridad privada", "contrato de servicio de seguridad", "cláusulas contrato seguridad privada", "SLA seguridad privada", "penalizaciones contrato guardias"]
tags: ["contrato de seguridad", "SLA seguridad privada", "contratación de guardias"]
category: "Seguridad Privada"
imageId: "6ee4f1e2-d022-4574-448e-20626971c100"
faqSchema:
  - question: "¿Qué debe incluir un contrato de servicio de seguridad privada?"
    answer: "Como mínimo: alcance y dotación por puesto, niveles de servicio (SLA) medibles, reglas de reemplazo y continuidad, penalizaciones por incumplimiento, seguros y responsabilidad civil, obligaciones laborales con entrega periódica del certificado F30-1, cumplimiento de la Ley 21.659 y la Ley 21.719, confidencialidad y condiciones de término."
  - question: "¿Qué es un SLA en un contrato de seguridad y por qué importa?"
    answer: "Un SLA (nivel de servicio) es un compromiso medible: cobertura de turnos, tiempo de respuesta ante incidentes, frecuencia de rondas o reportería. Importa porque convierte promesas comerciales en obligaciones verificables; sin indicadores y sin fuente de datos, no hay forma de exigir cumplimiento ni de aplicar descuentos."
  - question: "¿Cómo se maneja el reemplazo de guardias en el contrato?"
    answer: "El contrato debe fijar un tiempo máximo para cubrir una ausencia, exigir un perfil equivalente (acreditación OS10 e inducción al puesto) y establecer que todo turno no cubierto sin reemplazo se descuenta o penaliza. Sin esta cláusula, la 'dotación contratada' es solo una cifra en el papel."
  - question: "¿El contrato me protege de la responsabilidad laboral solidaria?"
    answer: "Ninguna cláusula elimina la responsabilidad solidaria de la Ley 20.123, pero el derecho a exigir el certificado F30-1 al día y a retener pagos ante incumplimientos laborales del proveedor te permite ejercer el derecho de información y retención, y así acotar el riesgo que hereda tu empresa como mandante."
  - question: "¿Cómo verifico que la empresa de seguridad está autorizada en Chile?"
    answer: "Debe estar autorizada por la Subsecretaría de Prevención del Delito conforme a la Ley 21.659, con su personal acreditado. Durante 2026 el Registro Nacional de Seguridad Privada está en implementación, así que la evidencia exigible en la transición es la resolución de autorización vigente, no necesariamente un número de inscripción."
---
...
Antes de llegar al contrato, el mandante ya debería haber comparado proveedores con criterios claros —revisa nuestra guía sobre [cómo elegir una empresa de seguridad privada](/blog/como-elegir-empresa-seguridad-privada)— y, si hubo licitación, haber definido bien las [bases de licitación del servicio](/blog/claves-para-elaborar-las-bases-de-licitacion-para-servicios-de-seguridad-privada). El contrato es el paso siguiente: convierte lo ofertado en obligaciones exigibles.

## Las cláusulas que no pueden faltar

### 1. Alcance del servicio y dotación por puesto

El contrato debe especificar sitio por sitio: cuántos guardias, en qué turnos, con qué funciones y qué queda expresamente excluido. La dotación no es un número global, sino una malla de turnos que debe cubrir las horas contratadas con la jornada legal vigente. Si no tienes claridad de cuántos guardias exige realmente un puesto continuo, revisa cómo se calcula la [dotación para un puesto 24/7](/blog/cuantos-guardias-turno-24-7-chile-2026): un puesto de 24 horas no lo cubre "un guardia", sino una malla de varios.
...
Desde la entrada en vigencia de la [Ley 21.659 de Seguridad Privada](/blog/ley-21659-seguridad-privada-chile), la fiscalización del sector recae en la **Subsecretaría de Prevención del Delito**, que autoriza a las empresas, aprueba estudios de seguridad y administra el Registro de Seguridad Privada ([Subsecretaría de Prevención del Delito](https://subprevenciondeldelito.gob.cl/noticia/a-partir-de-hoy-chile-tiene-nueva-ley-de-seguridad-privada/)). El contrato debe obligar al proveedor a mantener vigente su autorización y a que todo su personal esté acreditado. Durante 2026 el Registro Nacional está en implementación, por lo que la evidencia exigible en la transición es la resolución de autorización vigente. Contratar seguridad implica hacerlo dentro del sistema oficial; los pasos para contratar un servicio autorizado están descritos en [ChileAtiende](https://www.chileatiende.gob.cl/fichas/370-contratar-un-sistema-de-seguridad-privada).
...
Si estás por contratar o renovar tu servicio de [guardias de seguridad](/servicios/guardias-de-seguridad), revisa estas cláusulas con tu proveedor actual. ¿Quieres una propuesta con condiciones claras desde el primer día? [Cotiza tu servicio de seguridad](/cotizar) y conversemos sobre lo que tu operación realmente necesita.
