---
title: "Ley 21.561 y jornada excepcional de guardias en Chile 2026"
date: "2026-07-03"
description: "Desde el 26 de abril de 2026 la jornada bajó a 42 horas. Qué debe exigir tu empresa a su proveedor de guardias de seguridad para evitar responsabilidad."
...
La Ley 21.561 no es una norma exclusiva para seguridad privada: reduce gradualmente la jornada ordinaria máxima de todos los trabajadores del país, en un calendario fijo definido por el propio texto legal ([Biblioteca del Congreso Nacional](https://www.bcn.cl/leychile/navegar?idNorma=1191554)):
...
Para industrias con operación continua —[minería](/industrias/mineria) y [construcción](/industrias/construccion) entre las más intensivas en ciclos 4x4x12—, este punto es todavía más sensible: la dotación de guardias suele ser mayor y la exposición ante una fiscalización o demanda colectiva crece en la misma proporción.
...
Este último punto conviene resolverlo antes de la renovación de contrato, no durante una fiscalización. Empresas como [Gard Security](/servicios/guardias-de-seguridad) mantienen sus sistemas de jornada excepcional ajustados a cada rebaja legal desde su entrada en vigencia, y ponen la resolución de la DT a disposición del cliente como parte del proceso de onboarding — no como respuesta a una auditoría. Si necesitas una segunda revisión independiente de tu dotación actual o del contrato con tu proveedor, nuestro equipo de [consultoría en seguridad](/servicios/consultoria) puede apoyar ese diagnóstico.

Si tu empresa está evaluando un nuevo proveedor de guardias o quiere verificar el cumplimiento del actual frente a la Ley 21.561, puedes [cotizar con Gard Security](/cotizar) y pedir la documentación de respaldo como parte de la propuesta.

## Fuentes

- [Biblioteca del Congreso Nacional — Ley 21.561](https://www.bcn.cl/leychile/navegar?idNorma=1191554)
- [Dirección del Trabajo — ORD. N°253/21, implementación de la rebaja a 42 horas](https://www.dt.gob.cl/legislacion/1624/w3-article-129189.html)
- [Dirección del Trabajo — Subcontratación](https://www.dt.gob.cl/portal/1626/w3-article-93827.html)
- [Dirección del Trabajo — Autorización de jornada excepcional para guardias de seguridad](https://www.dt.gob.cl/portal/1626/w3-article-95850.html)
