---
title: "Botón de pánico para empresas: cómo funciona y cómo elegirlo"
date: "2026-07-31"
description: "Guía B2B del botón de pánico para empresas en Chile: cómo funciona, qué tipos existen, su conexión con la central de monitoreo y qué evaluar antes de contratar."
author: "Gard Security"
keywords: ["botón de pánico para empresas", "botón de pánico", "central de alarmas", "alarma monitoreada empresas", "botón de pánico central de monitoreo"]
tags: ["botón de pánico", "central de monitoreo", "alarmas monitoreadas"]
category: "Tecnología"
imageId: "0f25825a-dde5-4c16-9d18-f7dd43106200"
faqSchema:
  - question: "¿Cómo funciona un botón de pánico conectado a una central de monitoreo?"
    answer: "Al presionarlo, el botón envía una señal silenciosa a la central de monitoreo por red móvil, WiFi o radiofrecuencia. El operador verifica la situación —cuando hay cámaras, en video— y activa el protocolo acordado: contacto con el responsable del sitio y coordinación con Carabineros si corresponde."
  - question: "¿El botón de pánico avisa directamente a Carabineros?"
    answer: "No de forma automática. La señal llega primero a la central de monitoreo, que verifica el evento para descartar falsas alarmas y recién entonces coordina con Carabineros. La Ley 21.659 obliga a las empresas de seguridad privada a coordinarse con Carabineros y denunciar los delitos que conozcan."
  - question: "¿Qué diferencia hay entre un botón de pánico y una alarma tradicional?"
    answer: "La alarma tradicional reacciona ante una intrusión detectada por sensores, normalmente fuera de horario. El botón de pánico lo activa una persona presente durante un asalto o emergencia, incluso con el local abierto y ocupado. Son complementarios: cubren escenarios distintos dentro del mismo sistema."
  - question: "¿Es obligatorio tener botón de pánico en una empresa en Chile?"
    answer: "No existe una obligación legal general de instalar botón de pánico en toda empresa. Sí es exigible que el proveedor de seguridad esté inscrito en el registro de la Subsecretaría de Prevención del Delito (Ley 21.659) y, si el sistema usa cámaras, que el tratamiento de imágenes cumpla la Ley 21.719."
  - question: "¿De qué depende el costo de un botón de pánico para una empresa?"
    answer: "El costo varía según la cantidad de dispositivos y sitios, el tipo (fijo, inalámbrico o app), si incluye verificación por video, la cobertura de la central 24/7 y el tiempo de respuesta comprometido. Conviene cotizar sobre un análisis de riesgo del sitio en lugar de un precio genérico."
---
...
Por eso conviene entenderlos como parte de un mismo sistema de [prevención de intrusiones](/servicios/prevencion-intrusiones): sensores para cuando no hay nadie, botón de pánico para cuando sí lo hay, y cámaras que aportan verificación en ambos casos.

## El eslabón crítico: la central de monitoreo

Un botón de pánico vale exactamente lo que vale la central que hay detrás. La señal más rápida es inútil si nadie la recibe, la verifica y la escala. Por eso, al evaluar un servicio, el foco no debe estar en el dispositivo, sino en la **[central de monitoreo](/servicios/central-monitoreo)** que lo respalda.
...
Si quieres profundizar en cómo evaluar la operación de monitoreo detrás de tus cámaras y dispositivos, revisa nuestro [checklist para elegir proveedor de televigilancia](/blog/monitoreo-camaras-seguridad-empresas-checklist-2026).
...
**Ley 21.659, sobre Seguridad Privada.** Establece que la actividad de seguridad privada está bajo la rectoría de la Subsecretaría de Prevención del Delito, que autoriza, regula y fiscaliza a las empresas del sector. En la práctica, esto significa que el proveedor que instala y monitorea tu botón de pánico debe estar **inscrito en el registro** correspondiente. Contratar a un proveedor no registrado traslada riesgo legal y operativo a tu empresa. Puedes revisar el resumen oficial en la [ficha Ley Fácil de la BCN sobre seguridad privada](https://www.bcn.cl/portal/leyfacil/recurso/seguridad-privada).

**Ley 21.719, sobre Protección de Datos Personales.** Si tu botón de pánico se integra con cámaras —lo habitual para verificación—, estás tratando datos personales (imágenes de personas). La nueva ley, que entra en plena vigencia el **1 de diciembre de 2026**, exige una base de licitud, información clara a los titulares y resguardos reforzados; la videovigilancia en espacios de acceso público se considera un tratamiento de especial riesgo. Conviene alinear la implementación con estos requisitos desde el diseño. El texto está disponible en la [Biblioteca del Congreso Nacional](https://www.bcn.cl/leychile/navegar?i=1209272). Abordamos este punto en detalle en [videovigilancia y Ley 21.719](/blog/ley-21719-videovigilancia-empresas-chile).
...
- **¿La empresa está inscrita en el registro de la Subsecretaría de Prevención del Delito?** Exígelo por escrito.
...
- **Retail y farmacias:** cajas y ventanillas expuestas a asaltos rápidos. Se conecta bien con una estrategia integral de [prevención de pérdidas en retail](/blog/prevencion-perdidas-retail-chile) y con la seguridad de [locales comerciales](/industrias/retail).
...
En todos estos casos, el botón de pánico rinde cuando forma parte de un sistema —cámaras, [seguridad electrónica](/servicios/seguridad-electronica) y guardias— y no como una pieza aislada.
...
Gard Security opera con central de monitoreo propia 24/7, personal 100% acreditado OS10 y cobertura en las principales ciudades del país. Si quieres proteger a tu equipo con un botón de pánico integrado a monitoreo real, [cotiza tu servicio de seguridad](/cotizar) y define juntos el esquema que tu operación necesita.
