---
title: "¿Cuántos guardias necesito para un puesto 24/7?"
seoTitle: "Cuántos guardias necesito para un puesto 24/7 en Chile"
date: "2026-07-24"
description: "Un puesto 24/7 no lo cubre una sola persona. Con la jornada de 42 horas, así se calcula la dotación de guardias para presupuestar bien y exigir cobertura real."
author: "Gard Security"
keywords: ["cuántos guardias para un puesto 24/7", "dotación de guardias de seguridad", "guardias 24 horas", "turnos de guardias de seguridad"]
tags: ["Dotación de Guardias", "Turnos 24/7", "Contratación de Seguridad"]
category: "Seguridad Privada"
imageId: "770b0432-8f28-4b8a-6668-2da787d32400"
faqSchema:
  - question: "¿Cuántos guardias se necesitan para cubrir un puesto las 24 horas?"
    answer: "Un puesto 24/7 equivale a 168 horas semanales de cobertura. Con el tope legal de 42 horas por trabajador, el piso teórico es de 4 guardias (168 ÷ 42). En la práctica se dimensiona con 4 a 5 por puesto, porque hay que absorber vacaciones, feriados irrenunciables y licencias sin dejar el sitio descubierto."
  - question: "¿Por qué no basta con 3 guardias si son 3 turnos de 8 horas?"
    answer: "Tres guardias cubren un día, pero no una semana completa: cada uno tiene un tope de 42 horas semanales y derecho a descanso. Tres personas trabajando 56 horas cada una sería ilegal. Por eso el cálculo se hace sobre las 168 horas semanales del puesto, no sobre las 24 horas de un día aislado."
  - question: "¿Cómo afecta la jornada de 42 horas a la dotación de mi contrato?"
    answer: "La Ley 21.561 bajó la jornada a 42 horas semanales promedio desde el 26 de abril de 2026, y llegará a 40 horas en 2028. Menos horas por guardia significa más guardias por puesto para cubrir las mismas 168 horas. Si su contrato es anterior, conviene revisar que el proveedor haya ajustado la dotación."
  - question: "¿Puedo reducir la cantidad de guardias con tecnología?"
    answer: "Sí, en muchos puestos. Una central de monitoreo 24/7, cámaras con analítica y control de acceso electrónico permiten pasar de vigilancia presencial permanente a un esquema híbrido supervisado a distancia, reservando el guardia físico para las horas y accesos de mayor riesgo. Reduce dotación sin dejar el sitio sin cobertura."
  - question: "¿Qué debo exigir al proveedor para asegurar la cobertura 24/7?"
    answer: "Que la dotación cotizada incluya el factor de reemplazo (no solo los turnos base), un protocolo de reemplazo ante ausencias, guardias 100% acreditados en OS10 y un indicador de continuidad de turnos cubiertos. Pida que esos compromisos queden por escrito en el contrato, no como promesa verbal."
---
...
- **Feriado legal.** Todo trabajador con más de un año tiene derecho a [15 días hábiles de vacaciones](https://www.dt.gob.cl/portal/1628/w3-article-60177.html) al año, según el artículo 67 del Código del Trabajo. Mientras un guardia está de vacaciones, alguien tiene que ocupar su lugar.
...
- **Central de monitoreo 24/7.** Un [servicio de monitoreo remoto](/servicios/central-monitoreo) permite supervisar accesos y perímetros a distancia, reservando el guardia presencial para las horas y los accesos de mayor riesgo.
...
1. **Dotación con factor de reemplazo explícito**, no solo los turnos base.
2. **Protocolo de reemplazo ante ausencias**: quién cubre y en cuánto tiempo cuando un guardia falta.
3. **Guardias 100% acreditados en OS10**, la certificación obligatoria que exige la [Ley 21.659 de Seguridad Privada](/servicios/guardias-de-seguridad).
4. **Indicador de continuidad de turnos cubiertos**, medible y reportado. En Gard Security operamos con una continuidad operacional del 99,9% sobre turnos contratados, con central de monitoreo propia 24/7 y cobertura en las principales ciudades del país.
5. **Cumplimiento de jornada verificable**, para que la responsabilidad laboral no termine recayendo sobre su empresa como mandante.
...
¿Necesita dimensionar la dotación de uno o varios puestos? [Cotice su servicio de guardias](/cotizar) y le entregamos el cálculo de dotación, el esquema de turnos y la opción híbrida que corresponda a cada punto, con guardias acreditados y cobertura verificable.
