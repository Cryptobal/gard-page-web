...
faqSchema:
  ...
  - question: "¿Es obligatorio investigar los incidentes en la minería chilena?"
    answer: "El Decreto Supremo 132, Reglamento de Seguridad Minera fiscalizado por Sernageomin, obliga a la empresa minera a investigar los accidentes con lesión o muerte de trabajadores e implementar medidas correctivas. Investigar los cuasi-accidentes y demás incidentes sin lesionados no siempre es exigencia legal, pero sí una buena práctica y un requisito habitual del mandante; ICAM sirve para ambos casos."
...
En Gard abordamos la investigación de incidentes como parte de la gestión de seguridad de la faena, no como un trámite posterior al accidente. Nuestro equipo, con guardias 100% certificados OS10 y presencia en faenas remotas del norte, trabaja con la lógica ICAM para que los cuasi-accidentes —los que no dejan lesionados pero anticipan el evento grave— se investiguen con la misma seriedad que un accidente. Apoyamos la trazabilidad de las acciones correctivas con [tecnología de seguridad](/tecnologia-seguridad) y una central de monitoreo 24/7, dejando cada medida documentada y disponible para una auditoría del mandante o una fiscalización de Sernageomin. Investigar con rigor, además, tiene respaldo normativo: el [Decreto Supremo 132, Reglamento de Seguridad Minera](https://www.bcn.cl/leychile/Navegar?idNorma=221064) obliga a la empresa minera a investigar los accidentes con lesión o muerte de trabajadores e implementar medidas correctivas, y una metodología estructurada como ICAM es la forma de cumplir esa exigencia con evidencia.
