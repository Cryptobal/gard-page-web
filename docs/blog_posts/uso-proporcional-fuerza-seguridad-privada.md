---
title: "Uso proporcional de la fuerza en seguridad privada"
seoTitle: "Uso proporcional de la fuerza: guía para guardias privados en Chile | Gard Security"
date: "2026-07-14"
description: "Marco legal del uso proporcional de la fuerza en seguridad privada en Chile: límites, legítima defensa, de-escalada y por qué la Ley Naín-Retamal no aplica a los guardias privados."
author: "Gard Security"
keywords:
  - "uso proporcional fuerza guardias"
  - "uso proporcional fuerza seguridad privada Chile"
  - "de-escalada guardias"
  - "legítima defensa guardias privados"
  - "código penal guardias"
tags:
  - "uso de la fuerza"
  - "legítima defensa"
  - "de-escalada"
category: "Normativa"
imageId: "1cb6a897-a7b7-4dfb-4367-25ff876e6800"
faqSchema:
  - question: "¿La Ley Naín-Retamal protege a los guardias de seguridad privada?"
    answer: "No. La Ley 21.560, conocida como Naín-Retamal, creó una legítima defensa privilegiada que aplica solo a Carabineros, la PDI, Gendarmería y las Fuerzas Armadas en funciones de orden y seguridad pública. Un guardia privado no está cubierto por esa presunción: se rige por la legítima defensa general del artículo 10 del Código Penal, que exige probar cada requisito."
  - question: "¿Qué significa uso proporcional de la fuerza para un guardia?"
    answer: "Significa emplear solo la fuerza mínima e indispensable para repeler una agresión concreta, en una escala que parte por la presencia disuasiva y la comunicación verbal y llega al contacto físico únicamente como último recurso. La respuesta debe ser proporcional a la amenaza real: no se justifica una fuerza mayor que la necesaria para neutralizar el riesgo."
  - question: "¿Un guardia privado puede invocar legítima defensa en Chile?"
    answer: "Sí. La legítima defensa del artículo 10 del Código Penal aplica a toda persona, incluido un guardia, tanto para defenderse a sí mismo como para defender a terceros. Requiere agresión ilegítima, necesidad racional del medio empleado y —en la defensa propia— falta de provocación suficiente. Si falta un requisito o la fuerza es excesiva, la eximente no opera plenamente."
  - question: "¿Qué responsabilidad asume la empresa mandante si un guardia usa fuerza desproporcionada?"
    answer: "La empresa que contrata el servicio puede quedar expuesta a demandas civiles, querellas penales contra el guardia y cuestionamientos ante la Subsecretaría de Prevención del Delito bajo la Ley 21.659. Contar con un protocolo escrito de uso de la fuerza y capacitación documentada es parte de la diligencia mínima exigible al mandante y a su proveedor."
  - question: "¿Qué es la de-escalada y por qué es la primera respuesta?"
    answer: "La de-escalada es el conjunto de técnicas verbales y de conducta —tono calmado, distancia segura, instrucciones claras, presencia disuasiva— orientadas a resolver un incidente sin llegar al contacto físico. Es la primera respuesta porque reduce el riesgo para todas las partes, evita responsabilidad legal y refleja el estándar de proporcionalidad que exige tanto la ley como los marcos internacionales."
---

## El error que le puede costar caro a tu empresa

En abril de 2023 entró en vigencia la [Ley 21.560](https://www.bcn.cl/leychile/navegar?idNorma=1191005), conocida como "Naín-Retamal", y con ella se instaló una idea peligrosa en muchas instalaciones: que ahora un guardia puede "defenderse con respaldo legal reforzado" frente a cualquier agresión. Es un mito, y sostenerlo en terreno expone tanto al guardia como a la empresa mandante que lo contrató. El **uso proporcional de la fuerza** por parte de guardias de seguridad privada en Chile no se rige por esa ley, sino por el marco general del Código Penal, por la Ley 21.659 de Seguridad Privada y por estándares internacionales de proporcionalidad.
...
La base legal del uso de la fuerza por un civil —y un guardia privado lo es, jurídicamente— está en el [artículo 10 del Código Penal](https://www.bcn.cl/leychile/navegar?idNorma=1984), que exime de responsabilidad penal a quien obra en legítima defensa. La ley distingue tres hipótesis relevantes para el trabajo de seguridad:
...
Cada vez con más frecuencia, el mandante le traslada al contratista exigencias concretas: protocolos escritos de uso proporcional de la fuerza, registro e investigación de todo incidente en que se haya usado fuerza, y capacitación documentada. Desarrollamos ese marco en nuestro artículo sobre los [Principios Voluntarios (VPSHR) aplicados a la seguridad privada](/blog/principios-voluntarios-vpshr-seguridad-privada-mineria) y en nuestra [Política de Derechos Humanos](/politica-derechos-humanos). La convergencia es clara: el estándar internacional y el marco legal chileno apuntan a lo mismo, la fuerza como último recurso.
...
En Gard Security abordamos el uso de la fuerza como lo que es: un asunto de cumplimiento legal y gestión de riesgo, no de "mano dura". Nuestro plantel mantiene la [certificación OS10](/servicios/guardias-de-seguridad) vigente en el 100% de los guardias, sumamos contenidos de derechos humanos y de-escalada orientados al contexto de cada operación, y diseñamos protocolos de uso proporcional de la fuerza ajustados a las facultades legales reales del guardia en Chile. Esa es la diferencia entre un proveedor que traslada el riesgo al cliente y uno que lo administra.
...
¿Quieres asegurarte de que el personal que resguarda tu operación está formado en de-escalada y uso proporcional de la fuerza? [Cotiza con Gard Security](/cotizar) y conversemos sobre los protocolos que tu instalación necesita.
