---
title: "VPSHR en seguridad privada minera: guía para Chile"
seoTitle: "Principios Voluntarios (VPSHR) aplicados a seguridad privada en minería chilena"
date: "2026-07-11"
description: "Qué son los Principios Voluntarios sobre Seguridad y DD.HH. (VPSHR), qué exigen las mineras signatarias en Chile a sus empresas de seguridad y cómo cumplirlos."
author: "Gard Security"
keywords: ["VPSHR Chile seguridad", "Principios Voluntarios seguridad DDHH", "VPSHR minería Chile", "derechos humanos seguridad privada minería", "signatarios VPSHR Chile"]
tags: ["minería", "derechos humanos", "cumplimiento"]
category: "Normativa"
imageId: "012336cb-3fb3-4194-d267-a635a9651600"
faqSchema:
  - question: "¿Qué son los Principios Voluntarios (VPSHR)?"
    answer: "Los Principios Voluntarios sobre Seguridad y Derechos Humanos (VPSHR) son un estándar internacional creado en el año 2000 por los gobiernos de Estados Unidos y el Reino Unido, empresas extractivas y ONG. Guían a las compañías de minería, petróleo y gas para que protejan sus operaciones respetando los derechos humanos, y se organizan en tres componentes: evaluación de riesgos, relación con la seguridad pública y relación con la seguridad privada."
  - question: "¿Qué exige VPSHR a una empresa de seguridad privada en minería?"
    answer: "Una minera signataria traslada a su contratista de seguridad exigencias concretas: uso proporcional y excepcional de la fuerza, capacitación documentada en derechos humanos, investigación y registro de todo incidente con uso de fuerza, y un canal de denuncia accesible para trabajadores y comunidad. El contratista debe poder demostrar estos controles con evidencia auditable, no solo declararlos."
  - question: "¿Qué mineras que operan en Chile son signatarias de VPSHR?"
    answer: "Entre los miembros corporativos de la iniciativa figuran operadores con faenas en Chile como Anglo American, BHP, Glencore y Freeport-McMoRan, además de otras mineras globales. Al ser signatarias, estas compañías exigen a sus contratistas de seguridad alinear sus procedimientos con los VPSHR como condición para operar en faena."
  - question: "¿Qué relación tienen los VPSHR con los Principios Rectores de la ONU y el Convenio 169?"
    answer: "Los VPSHR aterrizan al ámbito de la seguridad la responsabilidad corporativa de respetar los derechos humanos que consagran los Principios Rectores de la ONU (2011). En Chile se complementan además con el Convenio 169 de la OIT, vigente desde 2009, que obliga a consultar a los pueblos indígenas ante medidas que los afecten, algo relevante cuando una faena colinda con territorio de comunidades."
  - question: "¿Ser signatario de VPSHR es lo mismo que cumplir la ley chilena?"
    answer: "No. La ley chilena, incluida la normativa de seguridad privada y el Reglamento de Seguridad Minera, fija el piso obligatorio. Los VPSHR son un estándar voluntario adicional que las mineras adoptan por compromiso y por exigencia de sus casas matrices e inversionistas. Cumplir la ley es necesario pero no suficiente para pasar la evaluación de un mandante signatario."
---
...
La respuesta no fue una nueva ley, sino un marco voluntario de conducta: un conjunto de principios que orientan a las empresas de minería, petróleo y gas para que provean seguridad **respetando los derechos humanos**. Según la [definición oficial de la iniciativa](https://www.voluntaryprinciples.org/the-principles/), se trata de una alianza multiactor —gobiernos, empresas y ONG— que sostiene y actualiza el estándar en el tiempo. Que sea voluntario no lo hace opcional en la práctica: para una minera Tier 1, adherir a los VPSHR es parte de su licencia social para operar y de las exigencias de sus inversionistas.

## Quiénes son signatarios en el sector minero global y en Chile

La iniciativa está formada por tres tipos de miembros: gobiernos, ONG y empresas. Entre los [miembros corporativos](https://www.voluntaryprinciples.org/for-companies/) figuran prácticamente todas las grandes mineras globales: Anglo American, BHP, Glencore, Freeport-McMoRan, Rio Tinto, Newmont, Barrick Gold, AngloGold Ashanti, Vale y MMG, entre otras. Varias de ellas operan yacimientos de primer nivel en Chile, lo que hace que el estándar aterrice directamente en el norte minero y en la Región Metropolitana.

Aquí está la parte que un decisor de seguridad no puede pasar por alto: cuando una minera es signataria, **traslada la exigencia a toda su cadena de contratistas**. La empresa de seguridad privada que patrulla el perímetro, controla accesos o resguarda instalaciones no firma los VPSHR —los firma el mandante—, pero queda obligada por contrato a operar bajo esos principios. En una evaluación de proveedores, no poder demostrar alineamiento con los VPSHR puede ser tan eliminatorio como no tener [guardias con OS10 vigente](/guardias-seguridad-mineria-chile). El estándar se vuelve, en los hechos, una barrera de entrada.
