---
title: "¿Puede un guardia detener a una persona en Chile? Guía 2026"
seoTitle: "¿Puede un Guardia de Seguridad Detener a una Persona? Marco Legal 2026 | Gard Security"
date: "2026-07-02"
description: "Qué puede y qué no puede hacer un guardia ante un delito flagrante en Chile, según la Ley 21.659 y el Código Procesal Penal, y qué responsabilidad asume tu empresa."
author: "Gard Security"
keywords:
  - "puede un guardia detener a una persona"
  - "detención ciudadana guardia de seguridad"
  - "guardia de seguridad puede arrestar"
  - "responsabilidad legal guardia de seguridad empresa"
  - "ley 21.659 flagrancia"
tags:
  - "ley 21.659"
  - "normativa"
...
faqSchema:
  ...
  - question: "¿Qué es la detención ciudadana y en qué se diferencia de un arresto policial?"
    answer: "La detención ciudadana es la facultad que el artículo 129 del Código Procesal Penal otorga a cualquier persona —no solo a guardias— para retener a quien sorprenda en delito flagrante. A diferencia del arresto policial, no incluye facultades de registro, interrogatorio ni traslado: el único deber es entregar al detenido de inmediato a la policía o al fiscal más próximo."
  - question: "¿Qué responsabilidad legal asume mi empresa si el guardia se excede al detener a alguien?"
    answer: "La empresa mandante puede verse expuesta a demandas civiles y cuestionamientos ante la Subsecretaría de Prevención del Delito si el guardia usa fuerza desproporcionada, detiene sin flagrancia real o retiene a la persona más tiempo del necesario para entregarla a Carabineros. Por eso el protocolo escrito y la capacitación del proveedor son parte de la diligencia mínima del mandante."
  - question: "¿Debe mi empresa exigir un protocolo escrito de actuación ante flagrancia?"
    answer: "Sí. Un protocolo claro —qué observar, cuándo intervenir, cómo dar aviso a la central de monitoreo, cómo entregar al detenido a Carabineros y qué registrar— reduce el riesgo legal de la empresa y protege al guardia de decisiones improvisadas bajo presión. Debe ser parte del contrato con el proveedor de seguridad, no un criterio informal de cada guardia."
  - question: "¿La Ley 21.659 cambió las facultades de los guardias frente a un delito flagrante?"
    answer: "La Ley 21.659 no modificó el artículo 129 del Código Procesal Penal, que sigue siendo la base legal de la detención ciudadana. Lo que sí introdujo es mayor fiscalización sobre las empresas de seguridad y sus guardias a través de la Subsecretaría de Prevención del Delito, lo que eleva el estándar exigido para que cada actuación quede respaldada por protocolos y registro adecuado."
---
...
La facultad de detener sin ser policía no nace de la [Ley 21.659 de Seguridad Privada](https://www.bcn.cl/leychile/navegar?idNorma=1202067), sino del [artículo 129 del Código Procesal Penal](https://www.bcn.cl/leychile/navegar?idNorma=176595), vigente desde hace más de dos décadas: "Cualquier persona podrá detener a quien sorprendiere en delito flagrante, debiendo entregar inmediatamente al aprehendido a la policía, al ministerio público o a la autoridad judicial más próxima."
...
Es un error común pensar que la nueva [Ley de Seguridad Privada](https://www.bcn.cl/leychile/navegar?idNorma=1202067), vigente desde el 28 de noviembre de 2025, amplió las atribuciones de los guardias frente a un delito. No fue así: el artículo 129 del Código Procesal Penal sigue intacto. Lo que la Ley 21.659 sí trajo es un estándar de fiscalización más alto sobre las empresas de seguridad y sobre cómo actúan sus guardias, a través de la [Subsecretaría de Prevención del Delito (SPD)](https://subprevenciondeldelito.gob.cl/noticia/a-partir-de-hoy-chile-tiene-nueva-ley-de-seguridad-privada/), que hoy autoriza a las empresas, acredita al personal y sanciona infracciones.
...
| Puede portar arma de fuego | No | Sí, en sistema aprobado | Sí |
...
Este es exactamente el tipo de estándar que una [auditoría de seguridad](/servicios/auditoria-seguridad) o una revisión de [consultoría en seguridad](/servicios/consultoria) debería verificar en un proveedor antes de firmar contrato, y no algo que se improvisa después de un incidente.

## Qué debe pedirle tu empresa al proveedor de guardias

Si tu empresa está evaluando o revisando un contrato de [guardias de seguridad](/servicios/guardias-de-seguridad), estas son las preguntas concretas que conviene hacerle al proveedor:
...
Si tu empresa necesita revisar cómo su proveedor actual gestiona estos protocolos, o evaluar un servicio de guardias con estándares claros de actuación y reporte, puedes [cotizar con Gard Security](/cotizar) y revisar el enfoque con nuestro equipo.
