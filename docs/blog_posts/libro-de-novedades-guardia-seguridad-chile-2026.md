---
title: "Libro de novedades del guardia: guía 2026 para empresas"
seoTitle: "Libro de novedades del guardia de seguridad: qué debe registrar y qué valor tiene para tu empresa"
date: "2026-08-26"
description: "Qué debe registrar el libro de novedades de un guardia de seguridad, qué valor tiene ante fiscalizaciones e incidentes y cómo auditarlo como empresa mandante."
author: "Gard Security"
keywords: ["libro de novedades", "libro de novedades guardia de seguridad", "bitácora de seguridad", "supervisión de guardias", "reportería de seguridad"]
tags: ["Operación", "Supervisión de guardias", "Guardias de seguridad"]
category: "Seguridad Privada"
imageId: "be570aa9-9eb8-4bbd-3e90-6e6a847b8900"
faqSchema:
  - question: "¿Para qué sirve el libro de novedades de una empresa?"
    answer: "Es el registro cronológico oficial de todo lo que ocurre en un puesto de guardia: incidentes, rondas, ingresos y salidas fuera de horario, visitas e instrucciones recibidas. Para la empresa mandante es la evidencia del servicio prestado y un antecedente clave ante fiscalizaciones, incidentes y seguros."
  - question: "¿Qué debe registrar el guardia en el libro de novedades?"
    answer: "Cada novedad del turno en orden cronológico y con hora: recepción y entrega del puesto con firma, rondas realizadas, incidentes y su respuesta, ingreso y salida de personas y vehículos fuera de la jornada habitual, visitas, fallas de sistemas (cámaras, cercos, iluminación) e instrucciones del supervisor."
  - question: "¿Cómo se llena correctamente un libro de novedades?"
    answer: "En orden de ocurrencia, con horario de 24 horas, renglón seguido y sin espacios en blanco ni hojas saltadas. No se borra ni se escribe sobre lo ya anotado: los errores se salvan con una nueva anotación. Al cambio de turno, el guardia saliente y el entrante firman la entrega y recepción del puesto."
  - question: "¿El libro de novedades puede servir como registro de asistencia?"
    answer: "La Dirección del Trabajo ha aceptado, para casos concretos de personal de vigilancia distribuido en instalaciones, que el libro de novedades opere como registro de control de asistencia (ORD. 792/59). Es una autorización específica: la responsabilidad laboral sigue siendo de la empresa de seguridad que contrata al guardia."
  - question: "¿El libro de novedades puede ser digital?"
    answer: "Sí. La bitácora digital con respaldo en línea gana terreno porque marca hora automáticamente, no se pierde ni se adultera con facilidad y permite al mandante revisar novedades sin visitar el sitio. Lo importante es que el formato elegido conserve trazabilidad, autoría y respaldo verificable de cada anotación."
---
...
No existe un formato único obligatorio: el detalle depende de la [directiva de funcionamiento](/blog/directiva-de-funcionamiento-seguridad-privada-chile-2026) de cada instalación y de los procedimientos del proveedor. Pero una bitácora bien llevada cubre, como mínimo, estos registros:
...
**Ante la autoridad.** Como revisamos en la [guía de fiscalización OS10 y SPD](/blog/fiscalizacion-os10-spd-seguridad-privada-chile-2026), el libro de novedades o bitácora de turno está entre los elementos que se examinan en una inspección típica de una instalación con guardias. Con la [Ley 21.659](https://www.bcn.cl/leychile/navegar?idNorma=1202067) vigente desde noviembre de 2025 y su reglamento, el [Decreto 209](https://www.bcn.cl/leychile/navegar?idNorma=1213672), el sistema quedó bajo un régimen de fiscalización más activo, y la lógica de registros operacionales verificables atraviesa toda la normativa.
...
- **Revisa las firmas de cambio de turno** de las últimas dos semanas: huecos en las firmas suelen ser huecos en la cobertura, el mismo problema que tratamos en la [guía de continuidad operacional del puesto](/blog/continuidad-operacional-guardias-reemplazos-chile-2026).
