---
title: "Seguridad en universidades: cómo proteger un campus"
seoTitle: "Seguridad universitaria en Chile 2026: guía para campus"
date: "2026-08-19"
description: "¿Cómo proteger un campus universitario en Chile? Guía de seguridad en universidades: riesgos reales, Ley 21.659, accesos, CCTV y cómo elegir al proveedor."
...
faqSchema:
  ...
  - question: "¿Un campus universitario necesita guardias acreditados OS10?"
    answer: "Sí, si contrata vigilancia privada. Ese servicio debe prestarlo una empresa autorizada por la Subsecretaría de Prevención del Delito conforme a la Ley 21.659, con personal acreditado OS10. El conserje o funcionario de portería que no cumple funciones de vigilancia no requiere OS10; el personal de vigilancia activa sí."
  - question: "¿El PISE o Escuelas Protegidas aplican a las universidades?"
    answer: "No. El Plan Integral de Seguridad Escolar y la Ley 21.827 de Escuelas Protegidas están pensados para establecimientos escolares. Las universidades se rigen por la Ley 21.091, su autonomía institucional y sus propios protocolos. Un proyecto en trámite busca explicitar el deber de resguardar la seguridad en las IES, pero aún no es ley."
  - question: "¿Cómo se controla el acceso en un campus abierto?"
    answer: "No se cierra el campus como una faena: se controla por capas. El perímetro puede permanecer transitable, mientras facultades, laboratorios, bodegas y residencias quedan restringidos con credencial. Los puntos de mayor flujo —acceso vehicular, biblioteca, casino— concentran a los guardias y el registro de visitas."
  - question: "¿Cuánto cuesta la seguridad de un campus universitario?"
    answer: "Depende de la cantidad de puestos, la cobertura horaria, la tecnología instalada y si hay residencias, eventos o laboratorios de alto valor. Lo correcto es partir de un levantamiento del campus y cotizar sobre esa base, no sobre un precio genérico por guardia sin contexto."
---
...
Esta guía está dirigida a ese decisor. No trata la [seguridad escolar de un colegio](/blog/seguridad-escolar-colegios-chile-2026) ni el PISE: la entidad aquí es el **campus de educación superior**. El volumen de gente que circula no es menor. Según el [informe de matrícula 2025 del SIES](https://educacionsuperior.mineduc.cl/2025/07/14/5-anos-de-crecimiento-sostenido-matricula-en-educacion-superior-crecio-un-5-respecto-al-2024/), de la Subsecretaría de Educación Superior, el sistema alcanzó **1.455.639 matrículas** y las universidades concentran el **59%** del total; el pregrado universitario llegó a **731.981**, la cifra más alta con registros. Más estudiantes significa más accesos, más eventos y más superficie que cuidar.
...
- **Autonomía institucional.** La [Ley 21.091 sobre Educación Superior](https://www.bcn.cl/leychile/navegar?idNorma=1118991) reconoce a las IES la potestad de conducir su proyecto en lo académico, económico y administrativo, dentro de la Constitución y la ley. La seguridad del campus la diseña la propia institución: no existe un PISE universitario obligatorio.
...
El debate de 2026 lo dejó en evidencia. La Cámara tramita el [boletín 18417-04](https://www.camara.cl/legislacion/ProyectosDeLey/tramitacion.aspx?prmID=19113&prmBOLETIN=18417-04) para explicitar en la Ley 21.091 el deber de resguardar la seguridad en las IES. Al 19 de agosto de 2026 sigue **en tramitación**: no es ley vigente. La Ley 21.827 de Escuelas Protegidas (Diario Oficial del 12 de agosto de 2026) aplica a colegios, no al campus. Mientras tanto, las instituciones ya se autorregulan: la Universidad Alberto Hurtado publicó en 2026 un [protocolo ante eventos críticos](https://www.uahurtado.cl/wp-content/uploads/2026/06/protocolo-de-seguridad-ante-eventos-criticos_UAH.pdf) desde su Vicerrectoría de Administración y Finanzas, anclado en la Ley 21.091 y en las normas de la Superintendencia de Educación Superior.
...
Los [guardias de seguridad](/servicios/guardias-de-seguridad) siguen siendo el corazón del sistema, pero su valor está en dónde se ubican: acceso vehicular, laboratorios o clínicas, residencias y rondas de perímetro en horario reducido. El público es adulto y académico; el estilo de una faena no sirve. La coordinación con operaciones y con Carabineros —sobre todo ante eventos o tomas— debe estar escrita.

### 2. Control de acceso por edificio, no solo por reja

En un campus abierto el perímetro puede permanecer transitable. Lo que no puede quedar abierto es el laboratorio, la bodega o la residencia. Un [sistema de control de acceso](/blog/control-de-acceso-empresas-chile-2026) permite que la credencial habilite la facultad y no el recinto completo, y que cada apertura quede registrada para investigar con datos, no con suposiciones.

### 3. Monitoreo que convierte la cámara en respuesta

Las cámaras sin alguien detrás son archivo. Una [central de monitoreo](/servicios/central-monitoreo) 24/7 transforma el CCTV en respuesta: detecta movimiento en un laboratorio a las 03:00, verifica la alarma del perímetro y deja registro. En campus con horario nocturno o recintos vacíos el fin de semana, esa diferencia se nota el lunes.
...
Gard Security opera con personal **100% acreditado OS10**, central de monitoreo propia 24/7 y cobertura en las principales ciudades de Chile. El enfoque para el sector está en [seguridad para educación](/industrias/educacion).
...
**[Solicite una cotización](/cotizar)** y coordine un levantamiento del recinto. La respuesta comercial de Gard queda en menos de 12 horas hábiles.
