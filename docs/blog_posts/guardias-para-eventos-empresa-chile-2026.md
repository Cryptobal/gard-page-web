---
title: "Guardias para eventos de empresa: qué exigir en 2026"
seoTitle: "Guardias para eventos de empresa en Chile 2026: qué exigir, aforo y plan de seguridad"
date: "2026-08-24"
description: "Guía B2B para contratar guardias para eventos de empresa en Chile: qué exigir al proveedor, aforo, plan de seguridad y umbral de 3.000 del Decreto 208."
...
faqSchema:
  ...
  - question: "¿A partir de cuántos asistentes se exige un plan de seguridad?"
    answer: "El Decreto 208 trata como evento masivo a aquellos con más de 3.000 asistentes estimados. También aplica bajo ese umbral si exige medidas especiales de seguridad o se realiza en un lugar no destinado de forma permanente a ese uso. En esos casos el plan de seguridad va en la solicitud de autorización, no como anexo opcional."
  - question: "¿Con cuánta anticipación se pide la autorización de un evento masivo?"
    answer: "El artículo 17 del Decreto 208 exige presentar la solicitud de autorización ante la Delegación Presidencial Regional con al menos sesenta días de antelación a la fecha del evento. Las solicitudes extemporáneas no se admiten, salvo casos calificados. Ese plazo es el que rige para el mandante; no lo reemplaza un trámite de último minuto con el proveedor de guardias."
  - question: "¿Qué es el aforo de un evento y quién lo fija?"
    answer: "El aforo es la cantidad máxima de personas que el recinto puede albergar, o la estimación de asistentes del organizador: para el cálculo de riesgo se toma el valor más alto. El número estimado nunca puede superar el aforo de seguridad del recinto. El proveedor de guardias no «inventa» ese número: lo opera y lo controla en los accesos."
  - question: "¿Puedo contratar guardias por mi cuenta para un evento corporativo?"
    answer: "No como servicio informal. Si el evento requiere vigilancia, debes contratar una empresa de seguridad privada autorizada, con personal acreditado. En un evento masivo el organizador está obligado a contratar guardias conforme a la Ley 21.659, y el plan de seguridad debe individualizar cantidad, distribución, turnos y la directiva de funcionamiento del servicio."
---
...
No reemplaza a la [landing de guardias para eventos y espectáculos](/servicios/guardias-de-seguridad/eventos-y-espectaculos), que es la página de servicio. Tampoco reescribe la [guía de requisitos de eventos masivos](/blog/seguridad-eventos-masivos-chile): esa cubre el marco del Título IV. Aquí el ángulo es el de quien **compra** el servicio y debe poder explicar, con documentos, quién vigila, con qué plan y con qué aforo.

## Qué cubre esta guía (y qué no)

Hay tres intenciones distintas que conviene no mezclar:

1. **Contratar guardias para un evento de empresa** (lanzamiento, convención, feria, acto interno, activación de marca): esta guía.
2. **Tramitar un evento masivo** de más de 3.000 asistentes —o uno menor que igual cae en el reglamento—: el post de requisitos y el Decreto 208.
3. **Proteger la planta o la oficina vacía** en un feriado: eso es continuidad operacional, no seguridad de público; lo tratamos en la guía de [empresas cerradas en Fiestas Patrias](/blog/proteger-empresa-fiestas-patrias-chile-2026).
...
| ¿Qué documento pega el servicio de guardias al permiso? | Contrato y credenciales | Plan de seguridad + [directiva de funcionamiento](/blog/directiva-de-funcionamiento-seguridad-privada-chile-2026) |

El trámite público de la autorización se describe en la [ficha de ChileAtiende](https://www.chileatiende.gob.cl/fichas/3784-solicitar-autorizacion-para-realizar-eventos-masivos): la Delegación Presidencial Regional resuelve con la Autoridad Sanitaria, Carabineros, la SEC, OS10 y el municipio, según el tipo de evento. El plazo que rige para un evento masivo, sin embargo, es el del Decreto 208 —sesenta días—, no un ingreso de último minuto.

## Qué debes exigir al proveedor de guardias

Aunque el evento no cruce los 3.000, el mandante sigue siendo quien responde si en la puerta hay alguien sin habilitación. El checklist es el mismo núcleo que usarías para un [servicio permanente de guardias](/servicios/guardias-de-seguridad), aplicado a una jornada con montaje, operación y desmontaje.

| Qué pedir por escrito | Por qué importa el día del evento |
|---|---|
| Resolución de autorización de la empresa ante la Subsecretaría de Prevención del Delito | Sin eso el servicio no es legal; la [Ley 21.659](/blog/ley-21659-seguridad-privada-chile) unificó el registro y la fiscalización |
...
| Puesto de mando y canal radial con la productora | La [resolución 772 exenta](https://www.diariooficial.interior.gob.cl/publicaciones/2026/03/03/44390/01/2777672.pdf) (3 de marzo de 2026) define el puesto de mando como el punto que centraliza incidentes y comunicaciones |
...
El servicio que Gard opera para [eventos y espectáculos](/servicios/guardias-de-seguridad/eventos-y-espectaculos) se diseña en ese ciclo: planificación del recinto, operación y desmontaje, con equipos diferenciados por función. La cotización parte de tu aforo y de tu recinto, no de un paquete genérico.
...
- **La instalación que queda sin gente** mientras todos están en el acto o de feriado: eso es el post de [protección de empresas en Fiestas Patrias](/blog/proteger-empresa-fiestas-patrias-chile-2026), con monitoreo y cobertura del predio vacío.
...
En recintos abiertos o periurbanos, un [dron de seguridad](/servicios/drones-seguridad) puede apoyar el perímetro o el estacionamiento; no reemplaza el control de acceso ni el puesto de mando.
...
Gard Security opera con personal 100% acreditado OS10, cobertura en 10 ciudades y respuesta comercial en menos de 12 horas hábiles. Si estás armando un evento de empresa —o el expediente de un masivo— [cotiza el servicio](/cotizar) con el recinto, la fecha y el aforo: con eso se dimensiona de verdad, no con una tarifa por hora suelta.
