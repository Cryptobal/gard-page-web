...
| Conectividad | GPS satelital para zonas sin cobertura celular y telemetría que transmita los eventos ADAS |
...
Y sobre la **conectividad**, el detalle que muchos contratistas subestiman: en faenas de la zona norte, gran parte del trayecto ocurre sin señal celular, por lo que el vehículo necesita GPS satelital para que los eventos no se pierdan hasta volver a cobertura. Si su empresa opera en el sector, conviene revisar cómo estructura su servicio de [seguridad para minería](/industrias/mineria) antes de cotizar la flota.
