---
title: "Responsabilidad solidaria al subcontratar seguridad privada"
seoTitle: "Responsabilidad solidaria y subsidiaria: guía para el mandante que contrata seguridad"
date: "2026-07-10"
description: "Cómo la responsabilidad solidaria de la Ley de Subcontratación expone a tu empresa a las deudas laborales de tu proveedor de guardias, y cómo blindarte."
author: "Gard Security"
keywords: ["responsabilidad solidaria", "ley de subcontratación", "certificado F30-1", "responsabilidad subsidiaria", "ley 20.123"]
tags: ["subcontratación", "responsabilidad solidaria", "cumplimiento normativo"]
category: "Normativa"
imageId: "9bed4914-e80c-41f7-2b23-8993dd3fde00"
faqSchema:
  - question: "¿Qué es la responsabilidad solidaria al contratar guardias de seguridad?"
    answer: "Es la obligación de la empresa mandante de responder por las deudas laborales y previsionales que el proveedor de seguridad tenga con sus guardias. Bajo la Ley 20.123 de Subcontratación, si tu empresa de seguridad no paga remuneraciones o cotizaciones, el trabajador puede cobrarle directamente a tu empresa, que contrató el servicio."
  - question: "¿Cuál es la diferencia entre responsabilidad solidaria y subsidiaria?"
    answer: "En la solidaria, el trabajador puede demandar directamente a la empresa mandante sin agotar antes al contratista. En la subsidiaria, primero debe perseguir al empleador directo y solo si este no responde va contra el mandante. La responsabilidad parte como solidaria y se atenúa a subsidiaria cuando el mandante ejerce sus derechos de información y retención."
  - question: "¿Qué es el certificado F30-1 y por qué debo exigirlo?"
    answer: "El F30-1 es el Certificado de Cumplimiento de Obligaciones Laborales y Previsionales que emite la Dirección del Trabajo. Acredita que tu proveedor pagó remuneraciones y cotizaciones de los trabajadores asignados a tu servicio. Solicitarlo periódicamente es la forma concreta de ejercer el derecho de información y limitar tu exposición."
  - question: "¿Cómo puede una empresa reducir su responsabilidad al subcontratar seguridad?"
    answer: "Ejerciendo el derecho de información —pidiendo el F30-1 y las planillas de cotizaciones al día antes de cada estado de pago— y el derecho de retención, reteniendo los montos adeudados a trabajadores cuando detecta incumplimiento. Elegir un proveedor formal, con documentación en regla, es la primera línea de defensa."
---
...
La seguridad privada es, por definición, un servicio en régimen de subcontratación: tu empresa (la mandante o "empresa principal") contrata a otra (el contratista) para que aporte trabajadores —los guardias— que prestan servicios dentro de tus instalaciones y bajo tu ámbito de organización. Ese esquema activa el Título VII del Libro I del Código del Trabajo, incorporado por la Ley 20.123.

El principio es directo: la empresa principal responde de las obligaciones laborales y previsionales de dar que el contratista tenga con sus trabajadores, por el tiempo en que estos prestaron servicios en régimen de subcontratación ([Dirección del Trabajo](https://www.dt.gob.cl/portal/1628/w3-article-94236.html)). En la práctica, esto abarca remuneraciones impagas, cotizaciones de AFP y salud no enteradas, e indemnizaciones que correspondan al término del contrato.
...
Este último punto conecta con algo que ya abordamos en nuestra guía sobre [cómo elaborar bases de licitación para servicios de seguridad](/blog/claves-para-elaborar-las-bases-de-licitacion-para-servicios-de-seguridad-privada): las cláusulas de cumplimiento laboral no son "letra chica", son parte del núcleo del contrato.
...
Los primeros dos controles atacan directamente el riesgo de responsabilidad solidaria; el último se cruza con la fiscalización sectorial, un tema que desarrollamos en detalle en nuestro artículo sobre [fiscalización OS10 y SPD](/blog/fiscalizacion-os10-spd-seguridad-privada-chile-2026). Un mismo proveedor informal puede exponerte por dos frentes a la vez: el laboral (Dirección del Trabajo) y el sectorial (Carabineros y la Subsecretaría de Prevención del Delito).
...
Esta es una de las razones por las que el [outsourcing de seguridad](/blog/los-beneficios-del-outsourcing-de-personal-de-seguridad-para-tu-empresa) solo entrega su promesa de tranquilidad cuando el proveedor es formal y financieramente sano. Un contratista que paga bien y a tiempo, que entrega su F30-1 sin que se lo pidan dos veces y que mantiene contratos y cotizaciones en regla, no es un gasto mayor: es un seguro contra una contingencia que puede costar mucho más que la diferencia de tarifa.

## Cómo lo abordamos en Gard

En Gard Security operamos con guardias 100% acreditados bajo OS10 y con contratos y cotizaciones en regla, precisamente para que la relación con nuestros clientes no genere exposición por responsabilidad solidaria. Nuestro [servicio de guardias de seguridad](/servicios/guardias-de-seguridad) contempla la entrega periódica de la documentación de cumplimiento —incluido el F30-1— como parte del servicio, no como un trámite que el cliente deba perseguir. Con cobertura operativa en 10 ciudades de Chile y central de monitoreo 24/7, el objetivo es que tu empresa reciba seguridad sin heredar riesgos laborales de terceros.

La responsabilidad solidaria no se elimina firmando un buen contrato: se administra exigiendo evidencia de cumplimiento y eligiendo un proveedor que no la ponga en riesgo. Si quieres revisar tu esquema actual de seguridad con esa mirada, [cotiza con nosotros](/cotizar) y evaluamos tu operación y su exposición.

*Este artículo tiene fines informativos y no constituye asesoría legal. Para casos específicos, consulta con tu área legal o con la [Dirección del Trabajo](https://www.dt.gob.cl/portal/1628/w3-article-94236.html).*
