---
title: "Fiscalización OS10 y SPD en Chile: guía 2026 para empresas"
seoTitle: "Fiscalización OS10 y SPD 2026: qué revisan a tu proveedor de guardias"
date: "2026-07-03"
description: "Quién fiscaliza a los guardias de seguridad en Chile en 2026, qué revisa Carabineros OS10 y la SPD, y qué debe tener listo el administrador del contrato."
...
faqSchema:
  ...
  - question: "¿Qué revisa Carabineros en una fiscalización OS10?"
    answer: "En una inspección típica se revisa la resolución OS10 de la empresa, las credenciales OS10 vigentes de cada guardia presente, el contrato de prestación de servicios, el listado actualizado de dotación asignada al sitio y el libro de novedades o bitácora de turno."
  - question: "¿Qué es la co-responsabilidad del mandante bajo la Ley 21.659?"
    answer: "Es la idea de que la empresa que contrata el servicio de seguridad no queda al margen si su proveedor incumple. Aunque las multas recaen formalmente sobre la empresa de seguridad, un mandante que contrata a un proveedor sin OS10 vigente o sin registro ante la SPD asume el riesgo operacional y reputacional de una clausura o suspensión del servicio en su propio sitio."
  - question: "¿Qué documentos debe tener listos el administrador del contrato ante una fiscalización?"
    answer: "El contrato de prestación de servicios vigente, el listado de guardias asignados con sus credenciales OS10 al día, evidencia de verificación periódica de esas credenciales y el canal de contacto del proveedor para responder a Carabineros o a la SPD el mismo día de una inspección."
  - question: "¿Qué pasa si mi proveedor de guardias no aprueba una fiscalización?"
    answer: "La Ley 21.659 clasifica las infracciones en leves, graves y gravísimas, con multas que van de 15 a 13.500 UTM según la gravedad, aplicadas por el juzgado de policía local. Un proveedor sancionado puede enfrentar suspensión de personal o clausura temporal, lo que deja al mandante sin cobertura de seguridad en el sitio hasta que se regularice."
---
...
(Fuente: [Ley 21.659, Biblioteca del Congreso Nacional](https://www.bcn.cl/leychile/navegar?idNorma=1202067)).
...
Este es exactamente el tipo de verificación que debería cubrir una [auditoría de seguridad](/servicios/auditoria-seguridad) periódica del proveedor, o una revisión inicial de [consultoría en seguridad](/servicios/consultoria) antes de firmar contrato — no algo que se improvisa cuando ya hay un fiscalizador en la puerta.

## Cómo se relaciona esto con los plazos generales de la Ley 21.659

Este checklist de fiscalización es complementario a las obligaciones normativas de fondo que ya explicamos en detalle en nuestra guía de [plazos críticos de la Ley 21.659](/blog/ley-21659-seguridad-privada-plazos-2026): estudio de seguridad, niveles de riesgo y registro ante la SPD. Si tu empresa todavía no tiene claro en qué nivel de riesgo se clasifica o qué plazos le aplican, ese es el punto de partida antes de preocuparte por el detalle de una inspección en terreno.

Para el detalle de cómo se obtiene y renueva la credencial individual de cada guardia, nuestra [guía completa de certificación OS10](/blog/certificacion-os10-guia-completa-chile-2025) cubre el proceso paso a paso.

## Qué exigirle a tu proveedor de guardias de seguridad

Si estás evaluando o renovando un contrato de [guardias de seguridad](/servicios/guardias-de-seguridad), estas son las preguntas concretas que conviene hacer antes de firmar:
...
Si tu empresa quiere revisar cómo su proveedor actual gestiona el cumplimiento OS10 y el registro ante la SPD, o evaluar un servicio de guardias con estos controles incorporados desde el inicio, puedes [cotizar con Gard Security](/cotizar) y revisar el enfoque con nuestro equipo.
