...
export default function TerminosServicio() {
  return (
    <LegalPageShell
      className="bg-white dark:bg-[hsl(var(--gard-background-darkest))] dark:bg-[url('/assets/noise-pattern.png')] dark:bg-opacity-95"
      containerClassName="max-w-3xl"
    >
      <LegalPageTitle title="Términos de Servicio" />
