...
const faqs = [
  { question: '¿Cuánto cuesta contratar guardias para una bodega logística en Chile?', answer: 'Depende de puestos, turnos, metraje y riesgo operativo. Entregamos cotización cerrada en menos de 12 horas hábiles con supervisión y control de accesos, sin publicar montos genéricos.' },
