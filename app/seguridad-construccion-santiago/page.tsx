...
const faqs = [
  ...
  { question: '¿Cuánto cuesta la seguridad para una obra en Santiago?', answer: 'Los precios en Santiago son: 1 guardia nocturno (20:00-08:00): $1.200.000-$1.400.000/mes. 2 guardias turno 12h diurno: $2.400.000-$2.800.000/mes ($1.200.000-$1.400.000 c/u). Para cobertura 24/7 se requieren 2-3 guardias por puesto (turnos rotativos): $2.500.000-$3.000.000 por puesto 24/7. El costo varía según tamaño de obra, comuna y nivel de riesgo. Solicite cotización personalizada.' },
