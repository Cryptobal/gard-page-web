...
const faqs = [
  ...
  { question: '¿Cuánto cuesta contratar guardias de seguridad en Antofagasta?', answer: 'Para faenas mineras remotas en Antofagasta, el costo promedio es $14.000.000-$18.000.000 mensuales por 4 puestos 24/7 (8 guardias reales, sistema 7x7), incluyendo transporte, bono zona, monitoreo satelital y logística. Para operaciones industriales/portuarias: $1.560.000-$1.800.000 por guardia turno 12h. El precio base en Antofagasta es 30-50% mayor que Santiago por costos de zona. Solicite cotización personalizada.' },
