...
export const metadata: Metadata = {
  ...
  description: 'Guardias de seguridad en Valparaíso especializados en puertos, zonas patrimoniales y turismo. Protección 24/7 para empresas, edificios y eventos. Cotice sin compromiso.',
      ...
      <section className="gard-section py-16 bg-primary text-white">
        <div className="gard-container max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-white/90">
            Especialistas en seguridad portuaria, patrimonial y turística con guardias certificados OS10 y protocolos probados
          </p>
