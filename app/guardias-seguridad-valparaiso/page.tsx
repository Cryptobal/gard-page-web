...
const faqs = [
  ...
  { question: '¿Cuánto cuesta contratar guardias en Valparaíso?', answer: 'Los precios en Valparaíso son: Seguridad portuaria: $1.320.000-$1.500.000 por guardia turno 12h. Edificios patrimoniales/turísticos: $1.320.000-$1.400.000 por guardia. Edificios corporativos Congreso: $1.320.000-$1.500.000 por guardia. El precio base en Valparaíso es 10-15% mayor que Santiago. Para equipos completos 24/7 (requiere múltiples guardias), solicite cotización personalizada.' },
